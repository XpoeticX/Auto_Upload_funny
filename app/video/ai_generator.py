...
PALETTES = {
    ...
    "romance": {
        "bg": (24, 10, 20),
        "card_a": (159, 18, 57), "border_a": (251, 113, 133), "badge_a": (190, 18, 60),
        "card_b": (112, 26, 117), "border_b": (232, 121, 249), "badge_b": (134, 25, 143),
        "accent": (254, 205, 211)
    },
    "gothic": {
        "bg": (10, 8, 14),
        "card_a": (69, 10, 10), "border_a": (220, 38, 38), "badge_a": (127, 29, 29),
        "card_b": (30, 27, 75), "border_b": (165, 180, 252), "badge_b": (49, 46, 129),
        "accent": (248, 113, 113)
    }
}
